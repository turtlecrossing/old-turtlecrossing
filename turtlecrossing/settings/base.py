...
# Absolute filesystem path to the local public server:
PUBLIC_ROOT = join(REPO_ROOT, 'public')
...
ADMINS = (
    ('Matthew Frazier', 'admin@turtlecrossing.org'),
)
...
SECRET_KEY = r"jzl+5ts+fz@k_9-(vj=!-e%*8_wcr$ecc*5y%hv$&1^*^*g6nr"
